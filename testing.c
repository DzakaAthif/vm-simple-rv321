...
int main(int argc, char** argv) {
    ...
    while(1) {
        ...
        // delete:
        printCommandBits(&file_memory, &pc);
        ...
        if (op_code == 51) {
            ...
            printf("f3: %d f7: %d rd: %d rs1: %d rs2: %d\n", func3, func7, rd, rs1, rs2);
            printBits(sizeof(unsigned char), &func3, " ", "func3", 1);
            printBits(sizeof(unsigned char), &func7, " ", "func7", 1);
            printBits(sizeof(unsigned char), &rd, " ", "rd", 1);
            printBits(sizeof(unsigned char), &rs1, " ", "rs1", 1);
            printBits(sizeof(unsigned char), &rs2, " ", "rs2", 1);
            ...
            if (func3 == 0 && func7 == 0) {
                ...
                printBits(sizeof(int), &(registers[rd]), " ", "rd", 1);
                printBits(sizeof(int), &(registers[rs1]), " ", "rs1", 1);
                printBits(sizeof(int), &(registers[rs2]), "\n", "rs2", 1);
                printf("sll\n");
                printf("\n");
            ...
            printf("f3: %d rd: %d rs1: %d imm_i: %d\n", func3, rd, rs1, imm);
            printBits(sizeof(unsigned char), &func3, " ", "func3", 1);
            printBits(sizeof(unsigned char), &rd, " ", "rd", 1);
            printBits(sizeof(unsigned char), &rs1, " ", "rs1", 1);
            printBits(sizeof(int), &imm, " ", "imm_i", 1);
            ...
            printf("rd: %d imm_u: %d\n", rd, imm);
            printBits(sizeof(unsigned char), &rd, " ", "rd", 1);
            printBits(sizeof(int), &imm, " ", "imm_u", 1);
            printf("lui\n");
            printf("\n");
            ...
            printf("f3: %d rs1: %d rs2: %d imm_s: %d\n", func3, rs1, rs2, imm);
            printBits(sizeof(unsigned char), &func3, " ", "func3", 1);
            printBits(sizeof(unsigned char), &rs1, " ", "rs1", 1);
            printBits(sizeof(unsigned char), &rs2, " ", "rs2", 1);
            printBits(sizeof(int), &imm, " ", "imm_s", 1);
            ...
            printf("f3: %d rs1: %d rs2: %d imm_sb: %d\n", func3, rs1, rs2, imm);
            printBits(sizeof(unsigned char), &func3, " ", "func3", 1);
            printBits(sizeof(unsigned char), &rs1, " ", "rs1", 1);
            printBits(sizeof(unsigned char), &rs2, " ", "rs2", 1);
            printBits(sizeof(int), &imm, " ", "imm_sb", 1);
            ...
            printf("rd: %d imm_uj: %d\n", rd, imm);
            printBits(sizeof(unsigned char), &rd, " ", "rd", 1);
            printBits(sizeof(int), &imm, " ", "imm_uj", 1);
            printf("jal\n\n");
            ...
            printf("func3: %d rd: %d imm_i: %d\n", func3, rd, imm);
            printBits(sizeof(unsigned char), &func3, " ", "rd", 1);
            printBits(sizeof(unsigned char), &rd, " ", "rd", 1);
            printBits(sizeof(int), &imm, " ", "imm_i", 1);
